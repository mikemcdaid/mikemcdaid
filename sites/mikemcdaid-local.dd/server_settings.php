...
//if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_mikemcdaid_local_dd.inc'))
//  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_mikemcdaid_local_dd.inc');
//</DDSETTINGS>

//<@@ADCP_CONF@@>
$base_url = 'http://mikemcdaid:8082';

//D6 DB config
$db_url = 'mysqli://drupaluser@127.0.0.1:33066/mikemcdaid';
